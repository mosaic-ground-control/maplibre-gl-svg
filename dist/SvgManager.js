...
export class SvgManager {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (typeof svg === "string") {
                ...
                if (map._requestManager._transformRequestFn) {
                    request = map._requestManager.transformRequest(imageSrc, "Image");
                }
                fetch(request.url, request)
                    ...
                    imageElm.onload = () => {
                        ...
                        if (maxWidth > 0 &&
                            maxHeight > 0 &&
                            (imageElm.width > maxWidth || imageElm.height > maxHeight)) {
     ...
     */
    createFromTemplate(id, templateName, color = "#1A73AA", secondaryColor = "white", scale = 1, text = "") {
