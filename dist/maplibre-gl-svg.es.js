class i {
  ...
  static getAllTemplateNames() {
    return Object.keys(i._imageTemplates);
  }
  /**
   * A list of built in image templates.
   */
  static _imageTemplates = {
    /**********************
     * Marker templates
     **********************/
...
class m {
  ...
  add(t, e, l = 100, s = 100, a = !1) {
    return new Promise((c, r) => {
      ...
      if (typeof e == "string") {
        let h;
        /<svg/i.test(e) && !/^data:/i.test(e) ? h = "data:image/svg+xml;base64," + window.btoa(e) : h = e;
        let w = {
          url: h
        };
        g._requestManager._transformRequestFn && (w = g._requestManager.transformRequest(
          h,
          "Image"
   ...
   */
  remove(t) {
    this._map.removeImage(t), delete this._images[t];
  }
  /**
